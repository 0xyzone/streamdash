<div class="flex items-center justify-between flex-shrink-0 px-3">
    ...
    <a href="{{ route('dashboard') }}" class="inline-flex items-center gap-2">
        <x-application-logo aria-hidden="true" class="w-32 h-auto" x-show="isSidebarOpen || isSidebarHovered" />
        <x-application-logo-mini aria-hidden="true" class="w-10 h-auto" x-show="!isSidebarOpen && (isSidebarHovered == false)" />
